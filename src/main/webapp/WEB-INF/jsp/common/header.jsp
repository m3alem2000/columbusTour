...
<title>Columbus Landmark Tour</title>
	    ...
	    <script type="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.16.0/jquery.validate.min.js"></script>
	    <script src="${jsHref}/jquery.validate.min.js"></script>
	    <script type="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.16.0/additional-methods.min.js"></script>
